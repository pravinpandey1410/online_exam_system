  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/pravin_pandey.jpeg" width=100 alt="Pravin Akhilesh Pandey" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		...
		<h4 style="font-family:'typo' ">S.I.C.E.S College (Y.C.M.O.U), Ambernath West</h4></div></div>
		</p>
      </div>
