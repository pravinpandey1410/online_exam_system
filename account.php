  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/pravin_pandey.jpeg" width=100 height=100 alt="Pravin Akhilesh Pandey" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Pravin Akhilesh Pandey</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917218449802</h4>
		<h4 style="font-family:'typo' ">pravinpandey721844@gmail.com</h4>
		<h4 style="font-family:'typo' ">S.I.C.E.S College, Ambernath west</h4></div></div>
		</p>
      </div>
